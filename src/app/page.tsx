...
export default function Home() {
  return (
    ...
    <div className="text-4xl text-center pb-5 font-bold">Share your Gossip Anonymously</div>
    ...
    <Link href={'/gossip'} className="bg-white text-black px-6 py-2 rounded-md text-xl my-8 transition-transform transform hover:scale-105">
      Get Started
    </Link>
