export default function NavBar() {
  return (
    <div className="bg-[#1a1a1a] w-full text-[#cbccce] border-b-[0.1px] border-[#2d2d2e] py-4 px-10 flex justify-between items-center fixed z-10">
      <div className="text-2xl">Roastroom</div>
